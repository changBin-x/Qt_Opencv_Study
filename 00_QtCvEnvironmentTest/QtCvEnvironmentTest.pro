...
#include(../oepncv430_MinGW_build/opencv430.pri)
#<<<<<<< HEAD
#=======

#Add opencv lib files here
#CONFIG(debug,debug|release):{
#LIBS+=-L../oepncv430_MinGW_build/bin/
#}else{
#LIBS+=-L../build/x64/vc15/lib/opencv_world430.lib
#}
#LIBS+=../oepncv430_MinGW_build/lib/libopencv_*.a
#>>>>>>> dev
